...
public:
    ...
    std::tuple<int, std::string> APIUnRegister(std::string API_Name, std::string PluginID);
    std::tuple<int, std::string> APIRegister(std::string API_Name, std::string PluginID);
